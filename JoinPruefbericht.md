...
- [x] **5 Tasks und 10 Kontakte** in Firebase befüllen (realistisch, kein Lorem Ipsum)
- [x] **Legal Notice** auf realitätsnahe Namen prüfen
- [x] **Manuelle Tests** in Chrome, Firefox, Safari, Edge
